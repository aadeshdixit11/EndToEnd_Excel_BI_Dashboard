...
2. **Transformation**  
   - Apply cleaning, merging, and shaping operations in Power Query.  
3. **Modeling**  
   - Use Power Pivot to connect transformed data with another Excel dataset.  
   - Define relationships and create calculated measures.  
4. **Analysis**  
   - Build PivotTables to explore KPIs and trends.  
5. **Visualization**  
